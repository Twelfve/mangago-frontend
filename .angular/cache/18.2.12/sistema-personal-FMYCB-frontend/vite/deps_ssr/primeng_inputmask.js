...
var InputMask = class _InputMask extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    standalone: true,
    features: [ɵɵProvidersFeature([INPUTMASK_VALUE_ACCESSOR, InputMaskStyle]), ɵɵInputTransformsFeature, ɵɵInheritDefinitionFeature, ɵɵStandaloneFeature],
    decls: 3,
    vars: 24,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(InputMask, {
    className: "InputMask"
  });
})();
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(InputMaskModule, {
    imports: [InputMask, SharedModule],
    exports: [InputMask, SharedModule]
  });
})();
